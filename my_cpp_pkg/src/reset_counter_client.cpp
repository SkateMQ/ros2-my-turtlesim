...
public:
    ...
    void callResetCounter(bool data)
    {
        ...
        client_->async_send_request(request, std::bind(&ResetCounterClientNode::callbackResetClient, this, _1));
    }

private:
    void callbackResetClient(rclcpp::Client<example_interfaces::srv::SetBool>::SharedFuture future)
    {
        ...
        if (response->success)
        {
            ...
            RCLCPP_WARN(this->get_logger(), "Failed! %s", response->message.c_str());
    }
